...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://www.instagram.com/clan_space_blank?igsh=Ymh3aXBzc2V5ZHE4.git "%USERPROFILE%\mystic"
...
git pull https://www.instagram.com/clan_space_blank?igsh=Ymh3aXBzc2V5ZHE4.git > git_output.txt
